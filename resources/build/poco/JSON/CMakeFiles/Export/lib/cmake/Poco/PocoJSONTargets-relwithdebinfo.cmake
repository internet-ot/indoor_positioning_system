...
set_target_properties(Poco::JSON PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib/libPocoJSON.so.51"
  IMPORTED_SONAME_RELWITHDEBINFO "libPocoJSON.so.51"
  )

list(APPEND _IMPORT_CHECK_TARGETS Poco::JSON )
list(APPEND _IMPORT_CHECK_FILES_FOR_Poco::JSON "${_IMPORT_PREFIX}/lib/libPocoJSON.so.51" )
